 ...
 * @authur David Harris Copyright (c) 2018
 */
public class EventSignalMast extends AbstractSignalMast {

    public EventSignalMast(String sys, String user) {
        super(sys, user);
        configureFromName(sys);
    }

    public EventSignalMast(String sys) {
        super(sys);
        configureFromName(sys);
    }

    public EventSignalMast(String sys, String user, String mastSubType) {
        super(sys, user);
